...
```bash
kubectl describe pod -l app.kubernetes.io/name=sureacccount-api -n sureacccount-api-dev
...
```bash
kubectl argo rollouts get rollout sureacccount-api -n sureacccount-api-dev
```
